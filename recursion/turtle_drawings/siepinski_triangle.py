...
def siepinski(points, degree, my_turtle):
    ...
    if degree > 0:
        ...
        siepinski(sub_triangle, degree - 1, my_turtle)
...
def main():
    ...
    win = turtle.Screen()
    my_turtle.speed(10)
    points = [Point(-100, -50), Point(0, 100), Point(100, -50)]
    siepinski(points, 3, my_turtle)
    win.exitonclick()
